...
interface SOPPaymentModalProps {
  open: boolean;
...
const PAYMENT_METHODS = {
  jazzcash: {
    ...
    bgPattern: "from-[#E30613] via-[#ff4757] to-[#E30613]",
  },
  easypaisa: {
    name: "Easypaisa",
    accountTitle: "Naeem Sabir",
    ...
    bgPattern: "from-[#00A651] via-[#2ed573] to-[#00A651]",
  },
  hbl: {
    name: "HBL Bank",
    accountTitle: "Naeem Sabir",
    ...
    bgPattern: "from-[#006C35] via-[#00a859] to-[#006C35]",
  },
};

const SOPPaymentModal = ({
  open,
  onOpenChange,
  sopId,
  university,
  ...
  const basePrice = packageTier === "standard" ? 1000 : 5000;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { error: paymentError } = await supabase.from("payment_verifications").insert({
        user_id: user.id,
  ...
  const handleWhatsApp = () => {
    window.open("https://wa.me/923224684181?text=Hi, I need help with my SOP payment.", "_blank");
  };
      ...
      <DialogContent className="sm:max-w-lg p-0 overflow-hidden bg-gradient-to-b from-card to-secondary/50 backdrop-blur-xl border border-border/50">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-border/50">
          ...
          <div className="mt-3 flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span className="truncate">{university} - {course}</span>
          </div>
        </div>
            ...
            {appliedPromo ? (
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">
                  {packageTier === "standard" ? "Standard" : "Expert"}
                </span>
              </div>
            )}
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                value={transactionId}
                onChange={(e) => {
                  // Allow only numbers and basic chars
...
export default SOPPaymentModal;
